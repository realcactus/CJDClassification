...
import numpy as np
from model.modules import get_token_embeddings, mlp, score_layer
...
class TextCNN(object):
    ...
    def __init__(self, config):
        ...
        self.embeddings = get_token_embeddings(self.config.vocab_size_w, self.config.embedding_dim,
                                               zero_pad=True)
        ...
        self.logits, self.y_pred_cls = score_layer(inputs=self.mean_pool, y_dim=self.config.num_classes)
